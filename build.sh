...
meson -Dcpp_link_args="-Wl,--no-undefined /usr/lib/$ARCH-linux-gnu/libgmp.a /usr/lib/$ARCH-linux-gnu/libXdmcp.a /usr/lib/$ARCH-linux-gnu/libXau.a /usr/lib/$ARCH-linux-gnu/libxcb.a" -Dbuildtype=release -Dstatic=system -Db_vscrt=static_from_buildtype \
